...
setup(
    ...
    data_files=[
        ...
        (f"share/{package_name}/config", glob.glob(os.path.join("config", "*.yaml"))),
        ...
        (
            f"share/{package_name}/models/turtlebot3_waffle",
            glob.glob(os.path.join("models", "turtlebot3_waffle", "*")),
        ),
    ],
    ...
    description="TD3-based Realsense/depth-scan goal navigation package for TurtleBot3 Waffle in ROS 2 Humble.",
    license="Apache-2.0",
    entry_points={
        "console_scripts": [
